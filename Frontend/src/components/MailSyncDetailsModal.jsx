...
export default function MailSyncDetailsModal({
  open,
  onClose,
  syncResult,
...
function resolveImportTypeLabel(typeId) {
  return IMPORT_TYPE_LABELS[String(typeId || "").trim().toLowerCase()] || "Okand typ";
}
...
function formatTimestamp(value) {
  ...
  if (Number.isNaN(parsed.getTime())) return "Okant datum";
